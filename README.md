...
- or to employ our trained networks for transfer learning tasks 
 ...
 you wish to contribute please `fork` our repository and open a `pull request` or simply get in touch via [E-mail](mailto:christoph.leitner@tugraz.at?subject=[GitHub]#deepMTJ).
